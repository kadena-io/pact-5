...
module Pact.Core.Repl.Compile where
--  ( InterpretOutput(..)
--  , interpretExprLisp
--  , lispInterpretBundle
...
--   = InterpretBundle
--   { expr :: ByteString -> ReplM ReplRawBuiltin (ReplEvalResult RawBuiltin SpanInfo)
--   , exprType :: ByteString -> ReplM ReplRawBuiltin (TypeScheme NamedDeBruijn)
--   , program :: ByteString -> ReplM ReplRawBuiltin [InterpretOutput ReplRawBuiltin SpanInfo]
--   }
...
-- interpretExpr
--   :: DesugarOutput ReplRawBuiltin SpanInfo (IR.Term Name ReplRawBuiltin SpanInfo)
--   -> ReplM ReplRawBuiltin (ReplEvalResult RawBuiltin SpanInfo)

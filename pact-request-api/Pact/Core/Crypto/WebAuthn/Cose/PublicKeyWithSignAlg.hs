...
module Pact.Core.Crypto.WebAuthn.Cose.PublicKeyWithSignAlg
  ( -- * COSE public Key
    PublicKeyWithSignAlg (PublicKeyWithSignAlgInternal, PublicKeyWithSignAlg, publicKey, signAlg),
    CosePublicKey
  )
where
...
import qualified Pact.Core.Crypto.WebAuthn.Cose.Registry as R
import qualified Pact.Core.Crypto.WebAuthn.Cose.PublicKey as P
import qualified Pact.Core.Crypto.WebAuthn.Cose.SignAlg as A
